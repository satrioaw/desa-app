(ns app.components.handler
  (:require [compojure.core :refer [defroutes]]
            ...
            [app.routes.cc :refer [cc-routes]]
            [app.routes.post :refer [post-routes]]
            [app.routes.user :refer [user-routes registration-routes]]
            [app.middleware :refer [load-middleware]]))
